...
Add the event class as a `sealed record` in `NosCore.GameObject.Messaging.Events/`. Add handlers anywhere in `NosCore.GameObject` — they are auto-discovered by convention.
