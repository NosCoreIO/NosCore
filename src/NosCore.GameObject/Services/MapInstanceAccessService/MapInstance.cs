...
namespace NosCore.GameObject.Services.MapInstanceAccessService
{
    public class MapInstance : IBroadcastable
    {
        ...
        private readonly IMapItemBuilderService _mapItemBuilderService;
        private readonly IMapMonsterBuilderService _mapMonsterBuilderService;
        private readonly IMapNpcBuilderService _mapNpcBuilderService;
        ...
        public MapInstance(Map.Map map, Guid guid, bool shopAllowed, MapInstanceType type,
            List<NpcMonsterDto> npcMonsters, IMapItemBuilderService mapItemBuilderService,
            IMapNpcBuilderService mapNpcBuilderService, IMapMonsterBuilderService mapMonsterBuilderService)
        {
