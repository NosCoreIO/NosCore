...
{
    public class MapInstanceAccessService : IMapInstanceAccessService
    {
        ...
        public MapInstanceAccessService(List<NpcMonsterDto> npcMonsters, List<Map.Map> maps,
            IMapItemBuilderService mapItemBuilderService, IMapNpcBuilderService mapNpcBuilderService,
            IMapMonsterBuilderService mapMonsterBuilderService)
        {
