...
namespace NosCore.GameObject.Services.MapInstanceGenerationService
{
    public interface IMapInstanceRegistry
    {
        ...
        bool TryRegister(Guid id, MapInstance mapInstance);
        bool TryUnregister(Guid id, out MapInstance? mapInstance);
        void Initialize(IDictionary<Guid, MapInstance> mapInstances);
