...
namespace NosCore.Core.Networking
{
    public class MasterServerSession : SimpleChannelInboundHandler<string>
    {
        ...
        public override void ChannelUnregistered(IChannelHandlerContext context)
        {
            ...
            Logger.Logger.Log.Warn(string.Format(LogLanguage.Instance.GetMessageFromKey(LogLanguageKey.UNREGISTRED_FROM_MASTER), _id.ToString()));
        }
        ...
        protected override void ChannelRead0(IChannelHandlerContext ctx, string msg)
        {
            ...
            if (!IsAuthenticated)
            {
                if (msgChannel.Password == Password)
                {
                    ...
                    Logger.Logger.Log.Debug(string.Format(LogLanguage.Instance.GetMessageFromKey(LogLanguageKey.AUTHENTICATED_SUCCESS), _id.ToString()));
                ...
                {
                    ctx.CloseAsync();
                    Logger.Logger.Log.Error(string.Format(LogLanguage.Instance.GetMessageFromKey(LogLanguageKey.AUTHENTICATED_ERROR)));
                }
            }
        }
        ...
        {
            Logger.Logger.Log.Debug(string.Format(LogLanguage.Instance.GetMessageFromKey(LogLanguageKey.REGISTRED_FROM_MASTER)));
        }
    }
}
