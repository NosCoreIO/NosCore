...
namespace OpenNosCore.GameHandler
{
    public class DefaultPacketHandler : IPacketHandler
    {
        ...
        public void GameStart(GameStartPacket packet)
        {
            ...
            {
                Session.SendPacket(Session.Character.GenerateSay("-------------------[OpenNosCore]---------------", 10));
                Session.SendPacket(Session.Character.GenerateSay($"Github : https://github.com/0Lucifer0/OpenNosCore/", 11));
