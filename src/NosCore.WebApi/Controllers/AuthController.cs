...
//        public AuthController(IOptions<WebApiConfiguration> apiConfiguration, IDao<AccountDto, long> accountDao, ILogger logger, IHasher hasher, IChannelHubClient channelHubClient )
//        {
...
//            _masterClientList.AuthCodes[authCode.ToString()] =
...
//            _masterClientList.ReadyForAuth.AddOrUpdate(intent.AccountName, intent.SessionId, (key, oldValue) => intent.SessionId);
//            return Ok();
//        }

//        [HttpGet]
//        public IActionResult GetExpectingConnection(string? a, string? token, long sessionId)
//        {
//            return Ok();
//        }
