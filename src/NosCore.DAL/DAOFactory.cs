...
namespace NosCore.DAL
{
    public static class DAOFactory
    {
        ...
        private static GenericDAO<Database.Entities.CharacterRelation, CharacterRelationDTO> _characterRelationDAO;
        ...
        public static GenericDAO<Database.Entities.CharacterRelation, CharacterRelationDTO> CharacterRelationDAO =>
            _characterRelationDAO ?? (_characterRelationDAO = new GenericDAO<Database.Entities.CharacterRelation, CharacterRelationDTO>(_mapper));
