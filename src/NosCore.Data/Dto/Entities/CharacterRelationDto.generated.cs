...
{
	/// <summary>
	/// Represents a DTO class for NosCore.Database.Entities.CharacterRelation.
	/// NOTE: This class is generated by GenerateDtos.tt
	/// </summary>
	public class CharacterRelationDto : IDto
	{
		internal CharacterDto Character1 { get; set; }

	 	internal CharacterDto Character2 { get; set; }
