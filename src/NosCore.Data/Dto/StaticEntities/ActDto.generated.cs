...
{
	/// <summary>
	/// Represents a DTO class for NosCore.Database.Entities.Act.
	/// NOTE: This class is generated by GenerateDtos.tt
	/// </summary>
	public class ActDto : IStaticDto
	{
		[Key]
		...
		public string TitleI18NKey { get; set; }
	 	...
	 	internal System.Collections.Generic.HashSet<ActPartDto> ActParts { get; set; }
