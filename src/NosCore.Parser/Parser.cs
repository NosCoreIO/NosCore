            ...
            try
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (key.KeyChar != 'n')
                        {
                            factory.ImportNpcMonstersAsync();
                        }
                        ...
                        if (key.KeyChar != 'n')
                        {
                            factory.ImportMapMonstersAsync();
                        }
