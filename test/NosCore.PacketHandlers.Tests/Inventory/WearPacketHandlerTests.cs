...
namespace NosCore.PacketHandlers.Tests.Inventory
{
    ...
    public class WearPacketHandlerTests
    {
        ...
        public async Task Test_Wear_Put_Item_CorrectSlotAsync(int typeInt)
        {
            ...
            await _wearPacketHandler!.ExecuteAsync(new WearPacket { InventorySlot = 0, Type = PocketType.Equipment }, _session);
        ...
        public async Task Test_Wear_SpInUseAsync()
        {
            ...
            await _wearPacketHandler.ExecuteAsync(new WearPacket { InventorySlot = 1, Type = PocketType.Equipment }, _session);
