...
namespace NosCore.PacketHandlers.Tests.Friend
{
    ...
    public class BlPacketHandlerTests
    {
        ...
        public async Task SetupAsync()
        {
            ...
            TestHelpers.Instance.ChannelHubClient.Setup(s => s.GetCharacterAsync(null, _session.Character.Name))
                .ReturnsAsync(
                    new ConnectedAccount
                    { ChannelId = 1, ConnectedCharacter = new Character { Id = _session.Character.CharacterId } });
        ...
        public async Task Test_Distant_BlacklistAsync()
        {
            ...
            TestHelpers.Instance.ChannelHubClient
             ...
             var blacklist = new BlacklistService(TestHelpers.Instance.ChannelHubClient.Object,
