...
//            _session = new ClientSession(null, new List<PacketController> { new ExchangePacketController(_worldConfiguration, _exchangeService, null) });
//            _session.RegisterChannel(channelMock.Object);
//            _session.InitializeAccount(account);
//            _session.SessionId = 1;

//            _controller = new ExchangePacketController(_worldConfiguration, _exchangeService, null);
//            _controller.RegisterSession(_session);
//            _session.SetCharacter(_character);
//            _exchangeService.ExchangeDatas[_session.Character.CharacterId] = new ExchangeData();
//            Broadcaster.Instance.RegisterSession(_session);

//            _session2 = new ClientSession(null, new List<PacketController> { new ExchangePacketController(_worldConfiguration, _exchangeService, null) });
//            _session2.RegisterChannel(channelMock.Object);
//            _session2.InitializeAccount(account2);
//            _session2.SessionId = 2;

//            _controller2 = new ExchangePacketController(_worldConfiguration, _exchangeService, null);
//            _controller2.RegisterSession(_session2);
//            _session2.SetCharacter(_character2);
//            _exchangeService.ExchangeDatas[_session2.Character.CharacterId] = new ExchangeData();
...
//            Assert.IsTrue(_exchangeService.ExchangeDatas[_session.Character.CharacterId].TargetVisualId == _character2.CharacterId && _character2.InExchangeOrShop);
//        }

//        [TestMethod]
//        public void Test_Cancel_Request()
//        {
//            _exchangeService.ExchangeDatas[_session.Character.CharacterId].TargetVisualId = _character2.VisualId;
