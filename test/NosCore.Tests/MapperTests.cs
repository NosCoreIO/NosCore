...
namespace NosCore.Tests
{
    ...
    public class MapperTests
    {
        ...
        public void Setup()
        {
            TypeAdapterConfig<CharacterDto, Character>.NewConfig().ConstructUsing(src => new Character(null, null, null, _characterDao, _itemInstanceDao, null, _accountDao, _logger, null));
