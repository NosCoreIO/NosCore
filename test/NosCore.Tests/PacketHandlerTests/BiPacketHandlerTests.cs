...
namespace NosCore.Tests.PacketHandlerTests
{
    ...
    public class BiPacketHandlerTests
    {
        ...
        public void Test_Delete_FromSlot()
        {
            ...
            { Option = RequestDeletionType.Confirmed, Slot = 0, NoscorePocketType = NoscorePocketType.Main }, _session);
        ...
        public void Test_Delete_FromEquiment()
        {
            ...
            _biPacketHandler.Execute(new BiPacket
            { Option = RequestDeletionType.Confirmed, Slot = 0, NoscorePocketType = NoscorePocketType.Equipment }, _session);
