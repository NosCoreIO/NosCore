...
namespace NosCore.Tests
{
    ...
    public class InventoryTests
    {
        ...
        public void Setup()
        {
            ...
            _itemCreatorService = new ItemCreatorService(_items);
        ...
        {
            var item = Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0)).First();
        ...
        {
            Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0));
            var item = Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0)).First();
        ...
        {
            Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 999));
            var items = Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0));
        ...
        {
            Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 990));
            var items = Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 29));
        ...
        {
            Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 990), slot: 0);
            Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 990), slot: 1);
            Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 990), slot: 2);
            var items = Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 27));
        ...
        public void CreateMoreItemThanInventoryPlace()
        {
            ...
            Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 990), slot: 1);
            Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 990), slot: 2);
            var items = Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 99));
        ...
        {
            Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 990));
            Inventory.AddItemToPocket(_itemCreatorService.Create(1013, 0, 990));
            Inventory.AddItemToPocket(_itemCreatorService.Create(1013, 0));
        ...
        public void CreateDoesntStackOnWrontItem()
        {
            Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 990));
            Inventory.AddItemToPocket(_itemCreatorService.Create(1013, 0, 990));
            Inventory.AddItemToPocket(_itemCreatorService.Create(1013, 0, 19));
        ...
        {
            Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 990));
            var items = Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 990));
            Assert.IsTrue(Inventory.Count == 2);
        ...
        {
            var item = Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 999)).First();
        ...
        {
            var item = Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 999)).First();
            Inventory.AddItemToPocket(_itemCreatorService.Create(1012, 0, 500)).First();
        ...
        {
            var fashion = Inventory.AddItemToPocket(_itemCreatorService.Create(924, 0)).First();
        ...
        {
            var specialist = Inventory.AddItemToPocket(_itemCreatorService.Create(912, 0)).First();
        ...
        {
            var weapon = Inventory.AddItemToPocket(_itemCreatorService.Create(1, 0)).First();
