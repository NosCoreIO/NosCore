...
namespace NosCore.GameObject.Tests
{
    ...
    public class GroupTests
    {
        ...
        {
            var entity = new Character(new Mock<IInventoryService>().Object, new Mock<IExchangeService>().Object, new Mock<IItemGenerationService>().Object, new HpService(), new MpService(), new ExperienceService(), new JobExperienceService(), new HeroExperienceService(), new ReputationService(), new DignityService(), TestHelpers.Instance.WorldConfiguration, new Mock<ISpeedCalculationService>().Object, new Mock<ISessionGroupFactory>().Object, TestHelpers.Instance.SessionRegistry)
            {
